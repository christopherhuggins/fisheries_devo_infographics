...
plot_england <- ggplot(filter(unique_vessels, nationality == "England"), aes(x = `Overall length`, stat(count))) +
  ...
  geom_text(aes(x = uk_mean, y = 0, label = "UK mean (9.5m)"), angle = 90, vjust = 1.5, hjust = 0, size = 3, colour = "#D55E00") +
  geom_vline(xintercept = 8.82, colour = "#0072B2") +
  geom_text(aes(x = 8.82, y = 0, label = "England mean (8.8m)"), angle = 90, vjust = -1.5, hjust = 0, size = 3, colour = "#0072B2") +
...
ggsave(plot_england, file = "england.png", height = 2.531496, width = 7.5905512, dpi = 1200)
...
plot_northernireland <- ggplot(filter(unique_vessels, nationality == "Northern Ireland"), aes(x = `Overall length`, stat(count))) +
  ...
  geom_vline(xintercept =  uk_mean, colour = "#D55E00") +
  geom_text(aes(x = uk_mean, y = 0, label = "UK mean (9.5m)"), angle = 90, vjust = -1.5, hjust = 0, size = 3, colour = "#D55E00") +
  geom_vline(xintercept = 11.8, colour = "#0072B2") +
  geom_text(aes(x = 11.8, y = 0, label = "Northern Ireland mean (11.8m)"), angle = 90, vjust = 1.5, hjust = 0, size = 3, colour = "#0072B2") +
  scale_y_continuous(limits = c(0,500), trans = "sqrt") +
  scale_x_continuous(limits = c(0,120), breaks = c(30,60,90,120)) +
  theme_ipsum(plot_margin = margin(7, 7, 7, 7),  plot_title_margin = 5) +
  theme(panel.grid.minor = element_blank()) +
  labs(title = "Northern Ireland", y = "Count", x = "Vessel length (metres)")
ggsave(plot_northernireland, file = "northernireland.png", height = 2.531496, width = 7.5905512, dpi = 1200)
...
plot_scotland <- ggplot(filter(unique_vessels, nationality == "Scotland"), aes(x = `Overall length`, stat(count))) +
  ...
  geom_vline(xintercept =  uk_mean, colour = "#D55E00") +
  geom_text(aes(x = uk_mean, y = 0, label = "UK mean (9.5m)"), angle = 90, vjust = -1.5, hjust = 0, size = 3, colour = "#D55E00") +
  geom_vline(xintercept = 10.5, colour = "#0072B2") +
  geom_text(aes(x = 10.5, y = 0, label = "Scotland mean (10.5m)"), angle = 90, vjust = 1.5, hjust = 0, size = 3, colour = "#0072B2") +
  scale_y_continuous(limits = c(0,500), trans = "sqrt") +
  scale_x_continuous(limits = c(0,120), breaks = c(30,60,90,120)) +
  theme_ipsum(plot_margin = margin(7, 7, 7, 7),  plot_title_margin = 5) +
  theme(panel.grid.minor = element_blank()) +
  labs(title = "Scotland", y = "Count", x = "Vessel length (metres)")
ggsave(plot_scotland, file = "scotland.png", height = 2.531496, width = 7.5905512, dpi = 1200)
...
plot_wales <- ggplot(filter(unique_vessels, nationality == "Wales"), aes(x = `Overall length`, stat(count))) +
  ...
  geom_vline(xintercept =  uk_mean, colour = "#D55E00") +
  geom_text(aes(x = uk_mean, y = 0, label = "UK mean (9.5m)"), angle = 90, vjust = 1.5, hjust = 0, size = 3, colour = "#D55E00") +
  geom_vline(xintercept = 7.17, colour = "#0072B2") +
  geom_text(aes(x = 7.17, y = 0, label = "Wales mean (7.2m)"), angle = 90, vjust = -1.5, hjust = 0, size = 3, colour = "#0072B2") +
  scale_y_continuous(limits = c(0,500), trans = "sqrt") +
  scale_x_continuous(limits = c(0,120), breaks = c(30,60,90,120)) +
  theme_ipsum(plot_margin = margin(7, 7, 7, 7),  plot_title_margin = 5) +
  theme(panel.grid.minor = element_blank()) +
  labs(title = "Wales", y = "Count", x = "Vessel length (metres)")
ggsave(plot_wales, file = "wales.png", height = 2.531496, width = 7.5905512, dpi = 1200)
...
ggsave(plot_u10_england, file="plot_u10_england.png", height = 4.070866, width = 4.377952, dpi = 1200)
...
plot_u10_northernireland <- ggplot(u10_northernireland, aes(x = "", y = pct, fill = category)) +
  ...
  theme(axis.text = element_blank(), panel.grid = element_blank(), legend.position = "bottom", legend.text=element_text(size=20)) +
  labs(fill = NULL, x = NULL, y = NULL)
ggsave(plot_u10_northernireland, file="plot_u10_northernireland.png", height = 4.070866, width = 4.377952, dpi = 1200)
...
plot_u10_scotland <- ggplot(u10_scotland, aes(x = "", y = pct, fill = category)) +
  ...
  theme(axis.text = element_blank(), panel.grid = element_blank(), legend.position = "bottom", legend.text=element_text(size=20)) +
  labs(fill = NULL, x = NULL, y = NULL)
ggsave(plot_u10_scotland, file="plot_u10_scotland.png", height = 4.070866, width = 4.377952, dpi = 1200)
...
plot_u10_wales <- ggplot(u10_wales, aes(x = "", y = pct, fill = category)) +
  ...
  theme(axis.text = element_blank(), panel.grid = element_blank(), legend.position = "bottom", legend.text=element_text(size=20)) +
  labs(fill = NULL, x = NULL, y = NULL)
ggsave(plot_u10_wales, file="plot_u10_wales.png", height = 4.070866, width = 4.377952, dpi = 1200)